...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    [AddComponentMenu("UI/NewButton", 30)]
    public class NewButton : Selectable, IPointerClickHandler, ISubmitHandler
    {
        ...
        ///
        /// 3. If Submit doesnft exist, add 1 number to the Size field. This creates a new section at the bottom. Expand the new section and change the Name field to gSubmith.
        ///
        ...
        protected override void DoStateTransition(SelectionState state, bool instant)
        {
            ...
            {
                m_Text.CrossFadeColor(color * colors.colorMultiplier * 1.3f, instant ? 0f : colors.fadeDuration, true, true);
            }
        }
        ...
        protected override void OnValidate()
        {
            ...
            {
                m_Text.color = colors.disabledColor;
            }
        }
